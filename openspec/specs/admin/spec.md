...
- Be a **client component** (following the API-as-boundary pattern — auth enforcement happens inside each API route via `requireAdmin()`)
- Fetch metrics and audit log data client-side on mount
